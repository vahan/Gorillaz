...
(function() {
  var EXPLOSION_IMAGE, MAX_ANGLE, MIN_ANGLE, PIXELS_PER_METER,
    ...
    EaselBoxMonkey.prototype.addActionListeners = function() {
      ...
      return this.easelObj.onPress = function(eventPress) {
        ...
        eventPress.onMouseMove = function(event) {
          var newAngle;
          newAngle = _this.prev_angle + Math.PI / 2 - Math.atan2(_this.easelObj.globalRegY - event.stageY, event.stageX - _this.easelObj.globalRegX) - Math.atan2(eventPress.stageX - _this.easelObj.globalRegX, _this.easelObj.globalRegY - eventPress.stageY);
          if (newAngle >= MIN_ANGLE && newAngle <= MAX_ANGLE) {
            _this.easelObj.angle = newAngle;
          }
          _this.setState({
          ...
          return _this.callingObject.updateInfoBar(_this.easelObj.angle);
        };
        return eventPress.onMouseUp = function(event) {
          ...
          if (_this.callingObject.getRound() === 0) {
            _this.easelObj.gotoAndPlay("shoot");
          }
          _this.removeActionListeners();
          return _this.callingObject.shoot(x, y, _this.easelObj.angle * -1);
        };
      };
    };
  ...
  window.EaselBoxWorld = (function() {
    ...
    EaselBoxWorld.prototype.shoot = function(x, y, angle) {
      this.angle = angle;
      if (this.callingObj.getRound() === 0 || this.callingObj.getRound() === this.callingObj.getMaxRounds()) {
        return this.shootBanana(x, y, angle);
      } else if (this.callingObj.getRound() > 0 && this.callingObj.getRound() < this.callingObj.getMaxRounds()) {
        return this.submit();
      }
    };
    ...
    EaselBoxWorld.prototype.shootBanana = function(x, y, angle) {
      ...
      if (!this.easelStage.contains(this.banana.easelObj)) {
        ...
        this.banana.body.ApplyImpulse(force, position);
        return this.banana.launch();
      } else {
        return console.log("Banana is already contained");
      }
    };
    ...
    EaselBoxWorld.prototype.addArrow = function() {
      this.arrow = new Bitmap("/img/ARROW/arrow.jpg");
      this.arrow.x = 170;
      this.arrow.y = -6;
      this.arrow.scaleX = 0.15;
      this.arrow.scaleY = 0.1;
      this.arrow.visible = true;
      this.infoBar.addChild(this.arrow);
      return this.arrow;
    };
    ...
    EaselBoxWorld.prototype.addResponseArrows = function(x, angles) {
      ...
      for (i = _i = 0, _len = angles.length; _i < _len; i = ++_i) {
        ...
        this.responseArrows.addChild(arr);
        _results.push(arr.visible = true);
      }
      return _results;
    };
    ...
    EaselBoxWorld.prototype.addInfoBar = function() {
      var infoBar;
    ...
    EaselBoxWorld.prototype.updateInfoBar = function(angle) {
      ...
      if (this.arrow != null) {
        this.arrow.rotation = angleDegree;
        return this.playerAngle.text = "your angle: " + angleDegree * -1;
      }
    };
    ...
    EaselBoxWorld.prototype.getRound = function() {
      return this.callingObj.getRound();
    };

    EaselBoxWorld.prototype.getStage = function() {
      return this.callingObj.getStage();
    };

    EaselBoxWorld.prototype.getBanana = function() {
      return this.banana;
    };

    EaselBoxWorld.prototype.getArrow = function() {
      return this.arrow;
    };

    EaselBoxWorld.prototype.waitForOthers = function() {
      this.message = new Text("Please wait for the other players", "20px Arial", "#ff7700");
      this.message.x = 450;
      this.message.y = 150;
      return this.easelStage.addChild(this.message);
    };
    ...
    EaselBoxWorld.prototype.tick = function() {
      ...
      if ((this.arrow != null) && this.arrow.image.width > 0 && !this.arrowDrawn) {
        ...
        this.arrow.regY = this.arrow.image.height / 2;
  ...
  window.EaselBoxBanana = (function() {
    ...
    EaselBoxBanana.prototype.launch = function() {
  ...
  window.EaselBoxArrow = (function() {
    ...
    EaselBoxArrow.prototype.drawme = function(xPixels, yPixels) {
      ...
      this.easelObj.graphics.beginFill(this.color);
    ...
    EaselBoxArrow.prototype.launch = function(angle) {
      this.launched = true;
      this.rotateme(angle * 180 / Math.PI);
      return this.easelObj.visible = true;
    };

    EaselBoxArrow.prototype.isOver = function() {
      return this.launched === true;
    };

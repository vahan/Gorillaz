...
(function() {
  var EXPLOSION_IMAGE, PIXELS_PER_METER,
  ...
  window.EaselBoxWorld = (function() {
    ...
    EaselBoxWorld.prototype.addResponseInfo = function() {
      ...
      if (type.innerHTML === "mean") {
        this.responseInfo.text += value.innerHTML;
      }
    ...
    EaselBoxWorld.prototype.isReady = function() {
      if (this.waitingTime === 50) {
        console.log("Ready!");
        return true;
      } else {
        return false;
    ...
    EaselBoxWorld.prototype.tick = function() {
      ...
      if (this.waitingTime >= 0) {
        ...
        if (this.meanAngle > 0) {
          this.addResponseArrow(170, meanAngle);
          this.waitingTime++;
        }
      }
